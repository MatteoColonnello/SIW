    ...
    protected void configure(HttpSecurity http) throws Exception {
       ...
       // anyone (authenticated or not) can access all static resources
        ...
        .anyRequest().authenticated()
                ...
                .defaultSuccessUrl("/paginaUtente")
